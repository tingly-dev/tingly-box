...
// ScenarioDescriptor keeps scenario validation policy explicit and configurable.
// If scenario validation is fully removed in the future, these policy fields can be dropped.
