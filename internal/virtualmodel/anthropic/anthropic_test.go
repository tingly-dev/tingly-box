...
func TestMockModel_Tool_Handle_DoesNotModifyReq(t *testing.T) {
	vm := NewMockModel(&MockModelConfig{
		ID:       "tool-test",
		ToolCall: &virtualmodel.ToolCallConfig{Name: "my_tool", Arguments: map[string]interface{}{"question": "proceed?"}},
	})
	req := makeReq("hi")
	_, _ = vm.HandleAnthropic(req)
...
func TestMockModel_Tool_Response_StopReasonIsToolUse(t *testing.T) {
	vm := NewMockModel(&MockModelConfig{
		ID:       "tool-test",
		ToolCall: &virtualmodel.ToolCallConfig{Name: "my_tool", Arguments: map[string]interface{}{}},
	})
	resp, _ := vm.HandleAnthropic(makeReq("hi"))
...
func TestMockModel_Tool_Response_ContentHasToolUseBlock(t *testing.T) {
	vm := NewMockModel(&MockModelConfig{
		ID:       "tool-test",
		ToolCall: &virtualmodel.ToolCallConfig{Name: "ask_user", Arguments: map[string]interface{}{"question": "sure?"}},
	})
	resp, _ := vm.HandleAnthropic(makeReq("hi"))
...
func TestMockModel_Tool_Response_DisplayContent_Question(t *testing.T) {
	vm := NewMockModel(&MockModelConfig{
		ID:       "tool-test",
		ToolCall: &virtualmodel.ToolCallConfig{Name: "ask_user", Arguments: map[string]interface{}{"question": "are you sure?"}},
	})
	resp, _ := vm.HandleAnthropic(makeReq("hi"))
...
func TestMockScenario_DefaultStopReasons(t *testing.T) {
	vm := NewMockFromScenario(&MockScenario{
		ID:       "sc-defaults",
		ToolCall: &virtualmodel.ToolCallConfig{Name: "fn", Arguments: map[string]interface{}{}},
	})
	resp, _ := vm.HandleAnthropic(makeReq("hi"))
	if resp.StopReason != "tool_use" {
		t.Errorf("expected StopReason 'tool_use', got %q", resp.StopReason)
...
func TestMockModel_HandleAnthropicStream_ToolModel_EmitsToolUseEvent(t *testing.T) {
	vm := NewMockModel(&MockModelConfig{
		ID:       "tool",
		ToolCall: &virtualmodel.ToolCallConfig{Name: "my_tool", Arguments: map[string]interface{}{"k": "v"}},
	})
	var events []any
