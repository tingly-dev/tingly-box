...
func TestMergeBetaStageUsagePreservesCurrentCacheDetails(t *testing.T) {
	total := &protocol.TokenUsage{InputTokens: 3, OutputTokens: 2, CacheReadTokens: 1, CacheWriteTokens: 2, ReasoningTokens: 1}
	current := &protocol.TokenUsage{InputTokens: 5, OutputTokens: 4, CacheReadTokens: 3, CacheWriteTokens: 4, ReasoningTokens: 2}

	got := mergeBetaStageUsage(total, current)
	if got.InputTokens != 8 || got.OutputTokens != 6 || got.CacheReadTokens != 4 || got.CacheWriteTokens != 6 || got.ReasoningTokens != 3 {
