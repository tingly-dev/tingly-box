...
func NewHandler(deps ProtocolHandlerDeps) *ProtocolHandler {
	...
	if deps.ProtocolStageEnabled {
		logrus.WithFields(logrus.Fields{
			...
			"stage_routes":      "anthropic_v1->anthropic_v1,anthropic_v1->openai_chat,anthropic_v1->openai_responses,anthropic_beta->anthropic_beta,anthropic_beta->openai_chat,anthropic_beta->openai_responses,openai_chat->anthropic_beta,openai_chat->openai_responses,openai_responses->openai_responses,openai_responses->anthropic_beta,openai_responses->openai_chat",
			"other_routes":      "legacy",
