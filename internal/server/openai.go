...
func (s *Server) HandleOpenAIChatCompletions(c *gin.Context) {
	...
	s.DoOpenAIChatCompletion(c, req, responseModel, provider, scenarioType, rule)
}

func (s *Server) DoOpenAIChatCompletion(c *gin.Context, req protocol.OpenAIChatCompletionRequest, responseModel string, provider *typ.Provider, scenarioType typ.RuleScenario, rule *typ.Rule) {
