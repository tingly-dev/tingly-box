...
// behind the managed_agent feature flag: every route must 404 while it is
...
func TestRegisterRoutes_GateBlocksWhenDisabled(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/api/v1/managed-agent/permission-modes", nil)
