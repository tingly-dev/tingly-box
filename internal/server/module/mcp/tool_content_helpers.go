...
func ToolContentsToAnthropicV1(contents []mcpruntime.ToolContent) []anthropic.ToolResultBlockParamContentUnion {
...
func ToolContentsToAnthropicBeta(contents []mcpruntime.ToolContent) []anthropic.BetaToolResultBlockParamContentUnion {
...
func toolContentsToAnthropicV1(contents []mcpruntime.ToolContent) []anthropic.ToolResultBlockParamContentUnion {
	...
	for _, c := range contents {
		switch c.Type {
		case mcpruntime.ContentTypeImage:
