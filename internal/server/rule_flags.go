...
func resolveRuleFlagsWithScenario(
	...
	// time. flags.Context1M is already true both when the rule sets it and when
	// detectAndApplyContext1MFromIncomingRequest saw the client's own beta flag
	// (it runs before flag resolution and sets the flag on the request-scoped
	// rule copy).
