...
// DiscordAdapter adapts Discord events to core.Message
...
func NewDiscordAdapter(config *core.Config, session *discordgo.Session) *DiscordAdapter {
...
func (a *DiscordAdapter) Platform() core.Platform {
	return core.PlatformDiscord
}

// AdaptMessage converts a Discord message create event to core.Message
func (a *DiscordAdapter) AdaptMessage(ctx context.Context, m *discordgo.MessageCreate) (*core.Message, error) {
...
func (a *DiscordAdapter) extractSender(user *discordgo.User) core.Sender {
	if user == nil {
...
func (a *DiscordAdapter) extractContent(msg *discordgo.Message) core.Content {
...
func (a *DiscordAdapter) convertAttachment(att *discordgo.MessageAttachment) core.MediaAttachment {
	mediaType := "document"
...
func (a *DiscordAdapter) formatEmbeds(embeds []*discordgo.MessageEmbed) string {
	if len(embeds) == 0 {
		return ""
	}
...
func (a *DiscordAdapter) getChatType(channelID string) core.ChatType {
	if a.session == nil {
...
func (a *DiscordAdapter) AdaptReaction(ctx context.Context, emoji *discordgo.MessageReactionAdd) (*core.Message, error) {
	if emoji == nil {
