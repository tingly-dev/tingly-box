...
func (*MatrixCmd) Help() string {
  ...
  # Run cross-request prompt-cache prefix-stability tests (per client shape)
  harness matrix --mode=cache_prefix

  # Run vendor-dispatch tests (ApplyProviderTransforms against real vendor APIBase)
  harness matrix --mode=vendor
