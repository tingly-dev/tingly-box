...
func TestHandler_Handshake_Success(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/opsx/handshake", nil)
	c.Request = req
...
func TestHandler_Handshake_WithBody(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/opsx/handshake", bytes.NewReader(bodyBytes))
...
func TestHandler_Execute_SessionNotFound(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/opsx/execute", bytes.NewReader(bodyBytes))
	req.Header.Set("Content-Type", "application/json")
	c.Request = req
...
func TestHandler_Execute_InvalidRequest(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/opsx/execute", nil)
	c.Request = req
...
func TestHandler_Status_SessionNotFound(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/opsx/status/non-existent", nil)
	c.Request = req
...
func TestHandler_Status_Success(t *testing.T) {
	...
	req := httptest.NewRequest("GET", "/opsx/status/"+session.ID, nil)
	c.Request = req
...
func TestHandler_Close_SessionNotFound(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/opsx/close", bytes.NewReader(bodyBytes))
	req.Header.Set("Content-Type", "application/json")
	c.Request = req
...
func TestHandler_Close_InvalidRequest(t *testing.T) {
	...
	req := httptest.NewRequest("POST", "/opsx/close", nil)
	c.Request = req
...
func TestHandler_Execute_FullFlow(t *testing.T) {
	...
	w := httptest.NewRecorder()
	c, _ := gin.CreateTestContext(w)
	req := httptest.NewRequest("POST", "/opsx/handshake", bytes.NewReader(handshakeBytes))
	req.Header.Set("Content-Type", "application/json")
	c.Request = req
	...
	w = httptest.NewRecorder()
	c, _ = gin.CreateTestContext(w)
	req = httptest.NewRequest("POST", "/opsx/execute", bytes.NewReader(executeBytes))
	req.Header.Set("Content-Type", "application/json")
	c.Request = req
	...
	w = httptest.NewRecorder()
	c, _ = gin.CreateTestContext(w)
	req = httptest.NewRequest("GET", "/opsx/status/"+handshakeResponse.SessionID, nil)
	c.Request = req
	...
	w = httptest.NewRecorder()
	c, _ = gin.CreateTestContext(w)
	req = httptest.NewRequest("POST", "/opsx/close", bytes.NewReader(closeBytes))
	req.Header.Set("Content-Type", "application/json")
	c.Request = req
