...
const messages: Record<string, Msg[]> = {
    ...
    'desk-2': [
        ...
        { role: 'assistant', content: 'Done — new installs now follow the OS theme until a choice is made.', timestamp: ago(40) },
    ],
    'desk-3': [
