...
const mockTasks: any[] = [
    ...
    { id: 'task-report', title: 'Generate migration notes', goal: 'Write migration notes for the completed routing refactor.', agent: 'claude', status: 'succeeded', latest_result: { state: 'done', summary: 'Migration notes written to docs/routing-migration.md.', artifacts: ['docs/routing-migration.md'] }, workspace_path: '/Users/demo/.tingly-box/tasks/task-report/workspace', session_id: '5727aa28-d554-49e9-8770-a413659f1988', resume_command: 'claude --resume 5727aa28-d554-49e9-8770-a413659f1988', follow_up: { enabled: false, delay_seconds: 300, max_wake_ups: 20 }, wake_count: 1, finished_at: new Date(Date.now() - 7200000).toISOString(), created_at: new Date(Date.now() - 10800000).toISOString(), updated_at: new Date(Date.now() - 7200000).toISOString() },
]
