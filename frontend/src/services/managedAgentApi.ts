// Managed Agent API — a web front door onto local Claude Code (see
// .design/managed-agent.md). Split out of services/api.ts following the
...
export const listRecentFolders = (limit?: number): Promise<RecentFolder[]> =>
    call((client, headers) => client.GET('/api/v1/managed-agent/folders/recent', {
        headers,
...
export const respond = (sessionId: string, requestId: string, approved: boolean, answer?: string): Promise<void> =>
    call((client, headers) => client.POST('/api/v1/managed-agent/sessions/{session_id}/respond', {
        headers,
        params: {path: {session_id: sessionId}},
...
export const setPermissionMode = (sessionId: string, mode: string): Promise<SessionInfo> =>
    call((client, headers) => client.PUT('/api/v1/managed-agent/sessions/{session_id}/permission-mode', {
        headers,
        params: {path: {session_id: sessionId}},
        body: {mode},
    }));
...
export const interrupt = (sessionId: string): Promise<void> =>
    call((client, headers) => client.POST('/api/v1/managed-agent/sessions/{session_id}/interrupt', {
        headers,
        params: {path: {session_id: sessionId}},
    })).then(() => undefined);
