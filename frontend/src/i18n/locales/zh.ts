export default {
  ...
  "tasks": {
    ...
    "composer": {
      ...
      "start": "开始",
      "starting": "启动中…",
      "addRepository": "先添加一个仓库",
      "noEnvironments": "没有可用环境"
    },
    "list": {
      "empty": "还没有任务",
      "recent": "任务",
      "emptyHint": "还没有任务。在上面描述一个任务即可开始。",
      "active": "进行中",
      "all": "全部",
      "branch": "分支",
      "changedFiles": "{{count}} 个文件改动",
      "changedFiles_other": "{{count}} 个文件改动",
      "lastActive": "最近活动",
      "noRepository": "未知仓库"
    },
    "status": {
    ...
    "detail": {
      ...
      "conversation": "对话",
      "changes": "改动",
      "steer": "告诉 agent 接下来做什么",
      "steerPlaceholder": "发送后续指令…",
      "send": "发送",
      "interrupt": "停止本轮",
      "archive": "归档",
      "archiveConfirmTitle": "归档这个任务？",
      "archiveConfirm": "agent 会彻底停止。分支和对话记录保留；之后可以在同一个 checkout 里开新任务。",
      "push": "推送分支",
      "pushed": "已推送",
      "pushing": "推送中…",
      "pushDone": "分支 {{branch}} 已推送",
      "openPR": "开 Pull Request",
      "noPROnBranch": "先推送，然后到 git 托管平台开 PR。",
      "diff": "Diff",
      "refreshDiff": "刷新",
      "noChanges": "还没有改动",
      "untracked": "未跟踪文件",
      "truncated": "补丁已截断，完整 diff 在 checkout 里。",
      "usage": "用量",
      ...
      "approvalTitle": "agent 想要运行 {{tool}}",
      "askTitle": "agent 有一个问题",
      "toolUse": "工具：{{name}}",
      "toolResult": "结果",
      "toolPending": "运行中…",
      "working": "工作中…",
      ...
      "showTools": "显示工具活动",
      "hideTools": "隐藏工具活动",
      "systemEvents": "{{count}} 个准备步骤",
      "systemEvents_other": "{{count}} 个准备步骤",
      "failed": "这个任务失败了",
      "running": "agent 正在工作…",
    ...
    "folder": {
      "title": "选择目录",
      "places": "你添加的目录",
      "noPlaces": "还没有添加过目录。在下方输入绝对路径并使用它；只有这样添加的目录才可以被浏览。",
      "path": "目录路径",
      "pathHelp": "运行 Tingly Box 那台机器上的绝对路径。在已添加目录之内回车可打开；否则直接使用即添加。",
      "up": "上一级",
      "empty": "没有子目录",
      "gitRepo": "git 仓库",
      "use": "使用此文件夹"
    ...
    "sources": {
      ...
      "remove": "从列表移除",
      "removeLocalTitle": "把这个目录从列表移除？",
      "removeLocalConfirm": "目录和里面的内容原样保留。Tingly Box 只是不再记住和列出它；在里面跑过的任务日志也保留。",
      "deleteConfirmTitle": "移除这个仓库？",
      "deleteConfirm": "已有的 checkout 不会被删除。有进行中任务的仓库不能移除。",
      "saved": "仓库已保存",
      "removed": "仓库已移除"
    },
    "environments": {
      "title": "环境",
      "subtitle": "agent 在哪里运行、拿到什么。Local 在这台机器上运行 Claude Code；Docker 会把它隔离在容器里，下一阶段提供。",
      "add": "添加环境",
      "edit": "编辑环境",
      "name": "名称",
      "runtime": "运行时",
      "runtimeLocal": "本机（Local）",
      "runtimeDocker": "Docker（暂不可用）",
      "image": "镜像",
      "setupScript": "准备脚本",
      "setupScriptHelp": "checkout 之后、agent 启动之前运行（安装依赖等）",
      "env": "环境变量",
      "envHelp": "每行一个 KEY=VALUE",
      "ccProfile": "Claude Code profile",
      "ccProfileHelp": "留空使用主 Claude Code scenario",
      "default": "默认",
      "empty": "没有环境",
      "deleteConfirmTitle": "删除这个环境？",
      "deleteConfirm": "有进行中任务的环境和默认环境不能删除。",
      "saved": "环境已保存",
      "removed": "环境已删除"
    }
  },
  "system": {
    ...
    "experimentalFeatures": {
      ...
      "managedAgent": "任务（托管 Agent）",
      "enableManagedAgent": "把仓库和一句任务交给 Claude Code，在网页或 IM 里随时插话，最后拿到一个分支",
      "managedAgentEnabledInfo": "任务已启用。侧边栏出现「任务」入口。",
