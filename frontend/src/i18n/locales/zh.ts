  ...
  "playground": {
    ...
    "sketch": {
      ...
      "pose": {
          ...
          "viewShort": "{{yaw}}° / {{pitch}}°",
          "fromPhoto": "从照片",
          "fromPhotoHint": "选一张有人的照片,人偶会摆成那个姿势。照片本身不会被使用。",
          "downloading": "正在下载姿态模型({{mb}} MB)…",
          "downloadFailed": "姿态模型下载失败——检查网络后重试",
          "detecting": "正在识别姿势…",
          "noPerson": "照片里没有找到人",
          "applied": "已按照片摆好姿势",
          "appliedMany": "已从照片添加 {{count}} 个人偶",
          "estimated": "照片里 {{count}} 个关节被遮挡,已估算",
          "unsupported": "当前浏览器无法运行姿态识别",
          "badImage": "这个文件不是图片",
          "group": {
            "standing": "站姿",
            "motion": "动作",
