export default {
  ...
  "bench": {
    ...
    "presetHint": "The preset request: one message, shaped by the Tool / Vision / Thinking knobs — it's the probe itself, materialized. To send anything else — multi-turn, images, tool results, provider-specific fields — write the request yourself.",
    "writeYourself": "Write the request yourself",
    ...
    "backToPreset": "Back to the preset request",
    "rawInvalid": "Not valid JSON: {{error}}",
    "rawHint": "Exactly what a client speaking {{protocol}} would send. The probe fills in the model (and max_tokens for Anthropic); Stream still applies; tools, images and thinking are yours to set here — the Tool / Vision / Thinking knobs only shape the preset request.",
    "rawProtocolSwitchHint": "Switching protocol replaces the body below with that protocol's starting template.",
