export default {
  ...
  "bench": {
    ...
    "fixtureHint": "The probe's built-in request: one message, shaped by the Tool / Vision / Thinking knobs. To send anything else — multi-turn, images, tool results, provider-specific fields — write the request yourself.",
    ...
    "backToFixture": "Back to the fixture",
    "templates": "Templates",
    "rawInvalid": "Not valid JSON: {{error}}",
    "rawHint": "Exactly what a client speaking {{protocol}} would send. The probe fills in the model (and max_tokens for Anthropic); Stream still applies; tools, images and thinking are yours to set here — the Tool / Vision / Thinking knobs only shape the fixture.",
    "knobOwnedByRaw": "Set by your raw request, not by this knob.",
    "protocolFromRaw": "The raw request's protocol — change it in the request editor.",
