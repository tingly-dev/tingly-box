export default {
  ...
  "bench": {
    ...
    "presetHint": "The preset request: one message, shaped by the Tool / Vision / Thinking knobs — it's the probe itself, materialized. To send anything else — multi-turn, images, tool results, provider-specific fields — switch Request mode to Custom.",
    "changeStartingPoint": "Change starting point",
    ...
    "scopeFull": "Full chain",
    "scopePinned": "Pinned rule",
    "scopeFullHint": "Exactly the production path: TB matches the rule from the request model. The Journey shows which rule actually matched.",
    "scopePinnedHint": "X-Tingly-Probe-Rule forces this rule; only rule matching is skipped. Use it when the request model collides with another rule or the rule is inactive.",
    "requestMode": "Request mode",
    "requestModeHint": "Preset: the probe builds it from the knobs below. Custom: you write it — Parameters and Presets stop applying.",
    "modePreset": "Preset",
    "modeCustom": "Custom",
    ...
    "ruleMismatch": "TB matched a different rule than the one you picked — this is what a real client would hit. Switch Scope to “Pinned rule” to force yours.",
    "subtitle": "One probe request with every knob resident: pick a target, shape the request, overlay flags, edit the payload. Nothing here is saved to a rule.",
    "run": "Run",
    "running": "Running…",
    "runHint": "⌘ / Ctrl + Enter",
    "runs": "Runs",
    "runsEmpty": "Runs from this session appear here — click one to restore its result and the config that produced it.",
    "compose": "Compose",
    "composeQ": "what do I send?",
    "target": "Target",
    "targetPlaceholder": "Search rules & providers…",
    "targetMissing": "The saved target no longer exists — pick another.",
    "targetEmpty": "Pick a rule or a provider model to start.",
    "targetLoading": "Loading rules and providers…",
    "rules": "Rules",
    "providers": "Providers",
    "plugins": "Plugins",
    "pluginsQ": "flag overlay · this request only",
    "overridden": "{{count}} overridden",
    "nothingOverridden": "nothing overridden — all inherited",
    "resetAll": "Reset all",
    "reset": "Reset to inherited",
    "inherit": "inherit: {{value}}",
    "inheritFrom": "inherit: {{value}} ({{source}})",
    "overriddenRow": "overridden for this request",
    "sourceRule": "rule",
    ...
    "pluginsNote": "Muted rows show the resolved baseline for this target (rule flags + scenario inheritance). Highlighted rows ride in the request's flags overlay. The response's Flags row is the authority.",
    "pluginsLoading": "Loading the flag registry…",
    "notEditable": "This flag type is edited on the rule itself.",
    "result": "Result",
  ...
  "system": {
    ...
    "experimentalFeatures": {
      ...
      "enableBench": "The probe test workbench — raw client requests, flag overlays and pinned routing",
      "on": "On",
      "off": "Off",
      "enabled": "enabled",
