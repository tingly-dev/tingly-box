export default {
  ...
  "bench": {
    ...
    "requestQ": "what the client sends",
    "presetHint": "One message, shaped by the Tool / Vision / Thinking knobs — it's the probe itself, materialized. To send anything else — multi-turn, images, tool results, provider-specific fields — pick a different Content above.",
    "startFromPreset": "Copy the preset request",
    "startFromPresetHint": "What the probe's own request would send right now.",
    "rawInvalid": "Not valid JSON: {{error}}",
    "rawHint": "Exactly what a client speaking this protocol would send. The probe fills in the model (and max_tokens for Anthropic); Stream still applies; tools, images and thinking are yours to set here — the Tool / Vision / Thinking knobs above only shape Content: Message.",
    "template": {"message": "Message", "messageDesc": "One message, shaped by the Tool / Vision / Thinking knobs below — the probe itself, materialized.", "custom": "Custom", "blank": "Blank", "blankDesc": "An empty request in this protocol's shape.", "multi": "Multi-turn", "multiDesc": "user → assistant → user. Conversion-fidelity baseline for any protocol pair.", "tool": "Tool round-trip", "toolDesc": "A tool definition, the assistant's call and the tool result — the shape agent frameworks send.", "image": "Image", "imageDesc": "A text + image user message, as the protocol expresses it.", "midsys": "Mid-conversation system", "midsysDesc": "A system message inside messages[] — the shape claude_code_compat exists for."},
    "editBody": "Edit",
    "editBodyHint": "Take this body into the request editor as a raw request and change anything.",
    "noteRaw": "Your own request, sent on its protocol's wire; only the model was filled in.",
    "content": "Content",
    "contentHint": "What the body is made of, for this protocol. Message keeps the knobs below live; anything else hands you a whole body to edit — either way there's exactly one author.",
    "axesInactive": "Reference only — this request is your own JSON now (Content: not Message), so these values aren't sent. Set them directly in the body.",
    "groupPresets": "Presets",
    "protocolCustomHint": "Chosen once, at the start of the custom request — switching it replaces the body with the new protocol’s starting template.",
    "subtitle": "One probe request with every knob resident: pick a provider model, shape the request, overlay flags, edit the payload.",
    "about": "About Bench",
    "run": "Run",
    "running": "Running…",
    "runHint": "⌘ / Ctrl + Enter",
    "runs": "Runs",
    "compose": "Compose",
    "composeQ": "what do I send?",
    "target": "Target",
    "targetPlaceholder": "Pick a provider & model…",
    "targetDialogTitle": "Choose a provider & model",
    "targetMissing": "The saved target no longer exists — pick another.",
    "targetEmpty": "Pick a provider model to start.",
    "targetLoading": "Loading providers…",
    "plugins": "Plugins",
    "pluginsQ": "flag overlay · this request only",
    "pluginsDirect": "Direct bypasses TB. Flags are TB middleware, so they cannot apply here — switch Scope to “Through TB” to test flags.",
    "result": "Result",
    "resultQ": "what happened?",
    "resultEmpty": "Not run yet — press Run to send exactly this request.",
    "overlaySent": "overlay sent: {{flags}}",
    "payload": "Payload",
    "payloadQ": "what actually goes out",
    "request": "Request",
    "headers": "Headers",
    "body": "Body",
    "addHeader": "+ Header",
    ...
    "applyBody": "Apply",
    "cancelEdit": "Cancel",
    "rebuilding": "Rebuilding… (500 ms debounce)",
    "builtFrom": "Built from POST /api/v2/probe/curl — the same builders the run uses.",
    "secretsHint": "Secrets stay as {{key}} — substitute before running by hand.",
    "noteThroughTB": "This is the request TB receives at its loopback entry: the protocol shape under test. Flags act after this point, inside TB — their effect shows in the response's Flags row.",
    "noteDirect": "Direct: the exact upstream request, authenticated with the provider key placeholder. No TB headers, no flags.",
    "buildFailed": "Could not build the request",
    "noTarget": "Pick a target to see the payload."
  },
  "probe": {
  ...
  "system": {
    ...
    "experimentalFeatures": {
      ...
      "enableBench": "The probe test workbench — raw client requests, flag overlays and payload editing",
      "on": "On",
      "off": "Off",
      "enabled": "enabled",
  ...
  "imageGenQuickStart": {
    "opGenerations": "images/generations",
    "opEdits": "images/edits",
  ...
  "sharingKeys": {
    ...
    "table": {
      ...
      "active": "Active",
      "inactive": "Disabled",
      "moveTooltip": "Move to another team",
      "deleteTooltip": "Delete token"
    }
  },
  "teams": {
  ...
  "imageLibrary": {
    "title": "Image Library",
    "subtitle": "Prompts, terms, phrases and reference images you keep. Stored in this browser.",
    "tabPrompts": "Prompts · {{count}}",
    "tabImages": "Reference images · {{count}}",
    "kind": {
      "all": "All",
      "prompt": "Prompt",
      "term": "Term",
    ...
    "kindHint": {
      "prompt": "A whole prompt — using it replaces the prompt field.",
      "term": "A keyword such as \"rim lighting\" or \"35mm\" — using it adds it to the prompt.",
      "phrase": "A descriptive sentence or clause — using it adds it to the prompt."
    },
    "new": "New",
    "newTitle": "New prompt material",
    "editTitle": "Edit",
    "titleLabel": "Title (optional)",
    "textLabel": "Text",
    "tagsLabel": "Tags",
    "tagsPlaceholder": "style, lighting, subject… (Enter to add)",
    "searchPrompts": "Search text and tags",
    "searchImages": "Search by name",
    "noMatches": "Nothing matches",
    "emptyPromptsTitle": "Keep the prompts that worked — and the parts that made them work",
    "emptyPromptsBody": "Save a prompt from the bookmark button on the Playground’s prompt field, or create one here. Then split it into terms (\"rim lighting\") and phrases (\"a quiet street after rain\") to reuse them in new prompts.",
    "useInPlayground": "Use in Playground",
    "addToPrompt": "Add to prompt",
    "fromPrompt": "from \"{{name}}\"",
    "pieceCount": "{{count}} pieces kept",
    "deletePromptTitle": "Delete \"{{name}}\"?",
    "deletePromptBody": "Removes it from the library.",
    "deletePromptKeepsPieces": "Removes it from the library. The pieces split from it are kept.",
    "split": {
      "action": "Split into terms and phrases",
      "title": "Split into terms and phrases",
      "hint": "A first cut at punctuation. Untick what is not worth keeping, fix the wording so each piece stands on its own, and mark it as a term or a phrase.",
      "addRow": "Add a piece",
      "tagsLabel": "Tags for every saved piece",
      "save_one": "Save {{count}} piece",
      "save_other": "Save {{count}} pieces",
      "saved": "Saved {{count}} pieces"
    },
    "promptMenu": "Saved prompts",
    "savePrompt": "Save this prompt",
    "promptAlreadySaved": "This prompt is in the library",
    "noPrompts": "Nothing saved yet",
    "appendHeading": "Add to the prompt",
    "loadPromptHeading": "Replace the prompt with",
    "openLibrary": "Open the library",
    "openLibraryAll": "All {{count}} in the library",
    "promptSaved": "Prompt saved to the library",
    "promptLoaded": "Prompt loaded from the library",
    "saveFailed": "Could not save to the library",
    "saveImage": "Save to library",
    "imageSaved": "Image saved to the library",
    "imageAlreadySaved": "This image is already in the library",
    "referenceSource": "Library",
    "pickReferencesTitle": "Add reference images from the library",
    "noReferencesPicker": "No images kept yet. Save one from the image viewer, or add your own on the library page.",
    "pickRoom": "{{picked}} picked · room for {{room}}",
    "pickNoRoom": "The request already has the maximum number of reference images",
    "pickConfirm_one": "Add {{count}} image",
    "pickConfirm_other": "Add {{count}} images",
    "addImages": "Add images",
    "dropHint": "Drop or paste images anywhere here",
    "imagesAdded": "Added {{count}} images",
    "emptyImagesTitle": "Keep the images you generate from again and again",
    "emptyImagesBody": "Add a character sheet, a style board or a product shot here, or save any image from the Playground’s image viewer. They show up under Library in the Playground’s reference row.",
    "useAsReference": "Use as reference",
    "rename": "Rename",
    "nameLabel": "Name",
    "deleteImageTitle": "Delete {{name}}?",
    "deleteImageBody": "Removes it from the library."
  },
  "playground": {
    ...
    "expandPrompt": "Open the prompt in a larger editor",
    "openPromptFile": "Open a text file as the prompt",
    "promptLoaded": "Prompt loaded from {{name}}",
    "promptFileEmpty": "{{name}} has no text in it",
    "promptFileTooLarge": "{{name}} is too large to be a prompt",
    "promptFileUnreadable": "Could not read {{name}}",
    "promptEditorTitle": "Prompt",
    "promptEditorDone": "Done",
    "size": "Size",
    "quality": "Quality",
    "count": "N",
    "generate": "Generate",
    ...
    "referencePaste": "Paste",
    "pasteHint": "Copy an image first, then press Ctrl+V / ⌘V here",
    "referencePromptPlaceholder": "Describe what to make from these images…",
    "generateFromReferences_one": "Generate from {{count}} image",
    "generateFromReferences_other": "Generate from {{count}} images",
    ...
    "previewHint": "Drop an image here to work on it without generating anything.",
    "sessionOutputs": "Session images",
    "outputDirLabel": "Generated images are saved to",
    "importCount": "{{count}} imported",
    "importedBadge": "Imported",
    "openImported": "Open {{name}}",
    "removeImported": "Remove {{name}}",
    "removeImportedTitle": "Remove {{name}}?",
    "removeImportedBody": "Removes it from the playground.",
    ...
    "gallery": {
      ...
      "clearAllBody_other": "Removes all {{count}} images from the playground. Images already written to the output folder stay on disk.",
      "fromReferences_one": "Generated from {{count}} reference image",
      "fromReferences_other": "Generated from {{count}} reference images",
    ...
    "mask": {
      ...
      "invert": "Invert",
      "clear": "Clear mask",
      "canvasAlt": "Mask canvas",
      "imageAlt": "Image being masked",
      "hint": "Painted areas are what the model may change; everything else stays. The prompt says what should appear there.",
      "cancel": "Cancel",
      "use": "Use mask",
      "update": "Update mask",
      "remove": "Remove mask",
      "loadFailed": "Could not read that image, so it cannot be masked.",
      "exportFailed": "Could not build the mask image.",
      "promptPlaceholder": "Describe what should appear in the painted area…",
    ...
    "sketch": {
      ...
      "pose": {
          ...
          "preset": {
            ...
            "tPose": "Arms out",
            "armsUp": "Arms up",
            "armsBehind": "Hands behind the back",
            "walking": "Walking",
            "running": "Running",
            "jumping": "Jumping",
            "kicking": "Kicking",
            ...
            "kneeling": "Kneeling",
            "crouching": "Crouching",
            "hugKnees": "Knees hugged",
            "reclining": "Reclining, propped up",
            "lying": "Lying on the back",
            "lyingSide": "Lying on the side",
    ...
    "slice": {
      ...
      "moreRows": "More rows",
      "fewerCols": "Fewer columns",
      "moreCols": "More columns",
      "rows": "Rows",
      "cols": "Columns",
      "frame": "Frame",
      "frameReset": "Whole image",
      "frameValue": "{{width}}×{{height}} px at {{x}},{{y}}",
      "frameTop": "Drag the top edge of the frame",
      "frameBottom": "Drag the bottom edge of the frame",
      "frameLeft": "Drag the left edge of the frame",
      "frameRight": "Drag the right edge of the frame",
      "frameTopLeft": "Top-left corner of the frame",
      "frameTopRight": "Top-right corner of the frame",
      "frameBottomLeft": "Bottom-left corner of the frame",
      "frameBottomRight": "Bottom-right corner of the frame",
      ...
      "zoomAnimation": "Enlarge the animation preview",
      "play": "Play preview",
      "pause": "Pause preview",
