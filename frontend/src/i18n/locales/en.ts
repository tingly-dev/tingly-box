export default {
  ...
  "dashboard": {
    ...
    "quotaHistory": {
      "title": "Quota history",
      "pageSubtitle": "Today's samples and past days' quota highs and lows.",
      ...
      "limitHint": "Showing the latest 5,000 samples. Choose a provider or shorter time range to see older samples."
    },
    "requestsView": {
      "title": "Requests",
      "total": "{{total}} total",
