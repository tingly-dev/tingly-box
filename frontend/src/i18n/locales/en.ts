  ...
  "playground": {
    ...
    "sketch": {
      ...
      "pose": {
          ...
          "fromPhotoHint": "Pick a photo of a person; the figure takes their pose. The photo itself is not used.",
          "downloading": "Downloading the pose model ({{mb}} MB)…",
          "downloadFailed": "Could not download the pose model — check the network and try again",
          "detecting": "Finding the pose…",
          "noPerson": "No person found in that photo",
          "applied": "Pose taken from the photo",
          "appliedMany": "{{count}} figures added from the photo",
          "estimated": "{{count}} joints were hidden in the photo and estimated",
          "unsupported": "This browser cannot run the pose estimator",
          "badImage": "That file is not an image",
          "group": {
            "standing": "Standing",
            "motion": "Motion",
            "seated": "Seated",
