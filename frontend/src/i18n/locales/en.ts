export default {
  ...
  "bench": {
    ...
    "pluginsNote": "A provider target has nothing to inherit — every flag starts at its default until you override it here. Highlighted rows ride in the request's flags overlay. The response's Flags row is the authority.",
