export default {
  ...
  "tasks": {
    ...
    "composer": {
      ...
      "promptPlaceholder": "Describe the task, e.g. add input validation to the signup form and cover it with tests",
      "repository": "Repository",
      "environment": "Environment",
      "start": "Start",
      "starting": "Starting…",
      "addRepository": "Add a repository first",
      "noEnvironments": "No environment available"
    },
    "list": {
      "empty": "No tasks yet",
      "recent": "Tasks",
      "emptyHint": "Nothing yet. Describe a task above to start one.",
      "active": "Active",
      "all": "All",
      "branch": "Branch",
      ...
      "noRepository": "Unknown repository"
    },
    "status": {
      "queued": "Queued",
      "running": "Running",
    ...
    "detail": {
      ...
      "changes": "Changes",
      "steer": "Tell the agent what to do next",
      "steerPlaceholder": "Send a follow-up…",
      "send": "Send",
      "interrupt": "Stop this turn",
      "archive": "Archive",
      "archiveConfirmTitle": "Archive this task?",
      "archiveConfirm": "The agent stops for good. The branch and the conversation log are kept; you can start a new task in the same checkout later.",
      "push": "Push branch",
      "pushed": "Pushed",
      "pushing": "Pushing…",
      "pushDone": "Branch {{branch}} pushed",
      "openPR": "Open pull request",
      "noPROnBranch": "Push first, then open a pull request on your git host.",
      "diff": "Diff",
      "refreshDiff": "Refresh",
      "noChanges": "No changes yet",
      "untracked": "Untracked files",
      "truncated": "Patch truncated; the full diff is in the checkout.",
      "usage": "Usage",
      "tokens": "{{input}} in / {{output}} out",
      "cost": "${{cost}}",
      "checkout": "Checkout",
      "claudeSession": "Claude Code session",
      "createdBy": "Started from",
      "approve": "Allow",
      "deny": "Deny",
      "answer": "Answer",
      "answerPlaceholder": "Your answer…",
      "approvalTitle": "The agent wants to run {{tool}}",
      ...
      "hideTools": "Hide tool activity",
      "systemEvents": "{{count}} setup step",
      "systemEvents_other": "{{count}} setup steps",
    ...
    "folder": {
      "title": "Pick a folder",
      "places": "Folders you added",
      "noPlaces": "No folders added yet. Type an absolute path below and use it; only folders you add this way can be browsed.",
      "path": "Folder path",
      "pathHelp": "Absolute path on the machine running Tingly Box. Enter opens it if it is inside a folder you added; otherwise use it as typed to add it.",
      "up": "Up",
    ...
    "sources": {
      ...
      "removeLocalTitle": "Remove this folder from the list?",
      "removeLocalConfirm": "The folder and everything in it stay exactly as they are. Tingly Box only forgets it and stops listing it; tasks that ran there keep their logs.",
      "deleteConfirmTitle": "Remove this repository?",
      "deleteConfirm": "Existing checkouts are not deleted. Repositories with live tasks cannot be removed.",
      "saved": "Repository saved",
      "removed": "Repository removed"
    },
    "environments": {
      "title": "Environments",
      "subtitle": "Where the agent runs and what it is given. Local runs Claude Code on this machine; Docker isolates it in a container and is coming next.",
      "add": "Add environment",
      "edit": "Edit environment",
      "name": "Name",
      "runtime": "Runtime",
      "runtimeLocal": "Local (this machine)",
      "runtimeDocker": "Docker (not available yet)",
      "image": "Image",
      "setupScript": "Setup script",
      "setupScriptHelp": "Runs after the checkout, before the agent starts (install dependencies, …)",
      "env": "Environment variables",
      "envHelp": "One KEY=VALUE per line",
      "ccProfile": "Claude Code profile",
      "ccProfileHelp": "Empty uses the main Claude Code scenario",
      "default": "Default",
      "empty": "No environments",
      "deleteConfirmTitle": "Delete this environment?",
      "deleteConfirm": "Environments with live tasks and the default environment cannot be deleted.",
  ...
  "system": {
    ...
    "experimentalFeatures": {
      ...
      "managedAgent": "Tasks (managed agent)",
      "enableManagedAgent": "Hand a repository and a prompt to Claude Code, steer it from the web or IM, and get a branch back",
      "managedAgentEnabledInfo": "Tasks is enabled. A \"Tasks\" rail is available in the sidebar.",
