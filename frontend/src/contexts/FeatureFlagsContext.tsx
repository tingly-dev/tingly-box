...
export const FeatureFlagsProvider: React.FC<FeatureFlagsProviderProps> = ({ children }) => {
    ...
    const loadFlags = async () => {
        try {
            const [skillUserResult, skillIdeResult, guardrailsResult, mcpResult, managedAgentResult] = await Promise.all([
    ...
    return (
        <FeatureFlagsContext.Provider value={{ skillUser, skillIde, enableGuardrails, enableMCP, enableManagedAgent, loading, refresh }}>
            {children}
