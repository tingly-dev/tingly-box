...
This chapter covers coding tool proxy scenarios beyond Claude Code and Codex: OpenCode, VS Code, Xcode, and Claude Desktop. Their configuration structure is similar to Claude Code.
