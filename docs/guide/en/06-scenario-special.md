# Custom / Embed / ImageGen

This chapter covers three specialized scenarios: the Custom catch-all scenario (formerly "OpenClaw"), Embedding API proxy, and Image Generation API proxy.
