...
| Z | 待定 | 清理：toolengine V1 adapter、`RunGenericAnthropicV1NonStream`、`AnthropicToOpenAIStreamWithMCPHooks` 钩子管线、无写入方的 `PopOpenAIContinuationSegment`、`protocol/stream` 中已无生产调用的 Responses→Anthropic handler 等 | — |
